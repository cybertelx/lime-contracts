...
contract LshareRewardPool {
    ...
    struct PoolInfo {
        ...
        uint256 lastRewardTime; // Last time that lshare distribution occurs.
    ...
    // set in setStart()
    uint256 public poolStartTime = 10**18;

    // The time when lshare mining ends.
    uint256 public poolEndTime = 10**18;

    uint256 public lsharePerSecond = 0 ether;
    uint256 public runningTime = 0 days;
    uint256 public constant TOTAL_REWARDS = 0 ether;
    ...
    // View function to see pending Lshare on frontend.
